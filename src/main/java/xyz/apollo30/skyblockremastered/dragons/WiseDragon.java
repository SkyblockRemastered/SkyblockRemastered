...
public class WiseDragon extends Dragon {
    ...
    public void getItem() {
        ...
        if (weight <=0 || damage <= 0) { Masterclass.broadcastWorld(plr, Helper.getRank(plr) + " has 0 weight L");
            ...
            Masterclass.broadcastWorld(plr, Helper.getRank(plr) + " &ehas obtained &6Mage Beam&e!");
