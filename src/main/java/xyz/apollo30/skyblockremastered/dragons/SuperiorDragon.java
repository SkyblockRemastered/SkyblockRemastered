    ...
    public void getItem() {
        ...
        if (weight <=0 || damage <= 0) { Masterclass.broadcastWorld(plr, Helper.getRank(plr) + " has 0 weight L");
            ...
            if (chance < 0.3) {
                ...
                plr.getInventory().addItem(s.DRAGON_HORN);
                Masterclass.broadcastWorld(plr, Helper.getRank(plr) + " &ehas obtained &5Dragon Horn&e!");
            }
            else if (chance < 25) {
