...
public class Weapons {
    ...
    public static ItemStack MAGE_BEAM = GUIHelper.addLore(new ItemStack(Material.IRON_BARDING), "&6Mage Beam", "&7Damage: &c+50", "&7Strength: &c+250", "&7Bonus Attack Speed: &c+100%", " ", "&7Intelligence: &a+250", " ", "&6Item Ability: Beam &e&lRIGHT CLICK", "&7All your melee weapon attacks become ranged.", "Those attacks deal &c40% &7of their melee damage", "&7also increased by 0.1 * intel", " ", "&8Mana Cost: &325", "&8Cooldown: &a0.5s", " ", "&8This item can be reforged!", "&6&lLEGENDARY");
