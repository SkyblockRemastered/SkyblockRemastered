...
public class Weapons {
    ...
    public ItemStack LIGHTNING_STAFF = Utils.addLore(new ItemStack(Material.BLAZE_ROD), "&6Lightning Staff", " ", "&7Damage: &c+170", "&7Strength: &c+100", "&7Crit Damage: &c+120%", " ", "&6Item Ability: Strike 'em! &e&lRight Click", "Strikes up to &85 &fnearby enemies", "for double your final damage!", "&8Cooldown: &a60s", " ", "&6&lLEGENDARY SWORD");
    public ItemStack MAGE_BEAM = Utils.addLore(new ItemStack(Material.IRON_BARDING), "&6Mage Beam", " ", "&7Damage: &c+50", "&7Strength: &c+980", "&7Bonus Attack Speed: &c+100%", " ", "&7Intelligence: &a+500", " ", "&6Item Ability: Beam &e&lRight Click", "Beams where you're looking", "and deals 0.2x more", "damage per intel point.", "&8Mana Cost: &325", "&8Cooldown: &a0s", " ", "&8This item can be reforged!", "&6&lLEGENDARY");
}
