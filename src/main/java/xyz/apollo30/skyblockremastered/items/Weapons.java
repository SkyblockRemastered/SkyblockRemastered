...
public class Weapons {
    ...
    public ItemStack LIGHTNING_STAFF = Utils.addLore(new ItemStack(Material.BLAZE_ROD), "&6Lightning Staff", " ", "&7Damage: &c+170", "&7Strength: &c+100", "&7Crit Damage: &c+120%", " ", "&6Item Ability: Strike 'em! &e&lRight Click", "&7Strikes up to &a5 &7nearby enemies", "&7for double your final damage!", "&8Cooldown: &a60s", " ", "&6&lLEGENDARY SWORD");
