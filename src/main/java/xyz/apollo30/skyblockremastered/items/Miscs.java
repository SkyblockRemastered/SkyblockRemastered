...
public class Miscs {
    ...
    public ItemStack SKYBLOCK_MENU = Utils.createItem(null, "NETHER_STAR", 1, 9, "&aSkyBlock Menu &7(Right Click)",
            "&7View all of your SkyBlock", "&7progress, including your Skills,",
            "&7Collections, Recipes, and more!");

    public ItemStack REMNANT_OF_THE_EYE = Utils.addLore(
    ...
    public ItemStack SUMMONING_EYE = Utils.addLore(
    ...
    public ItemStack GRAPPLING_HOOK = Utils.addLore(new ItemStack(Material.FISHING_ROD), "&aGrappling Hook", "&7Travel around in style using", "&7this Grappling Hook.", "&82 Second Cooldown", " ", "&a&lUNCOMMON");

    public ItemStack CRYSTAL_FRAGMENT = Helper.addEnchantGlow(Utils.addLore(new ItemStack(Material.QUARTZ), "&5Crystal Fragment", "&eRight-click to view recipes!", " ", "&5&lEPIC"));

    public ItemStack WEIRD_TUBA = Utils.addLore(new ItemStack(Material.HOPPER), "&9Weird Tuba", "&6Item Ability: Howl &e&lRight Click", "&7You and 4 nearby players gain:", "&c+30❁ Strength", "&f+30✦ Speed", "&7for &a 20 &7seconds.", "&8Effects doesn't stack.", "&8Mana Cost: &3150", "&8Cooldown: &a20s", " ", "&4☠ &cRequires &5Wolf Slayer 5", "&9&lRARE");

    public ItemStack PLASMAFLUX_POWER_ORB = Utils.addLore(Utils.getSkull(""), "&6Plasmaflux Power Orb", "&6Item Ability: Deploy", "&7Place an orb for &a60s &7buffing", "&7up to &b5 &7player within &a20", "&7blocks.", "&8Costs 50% of max mana.", "&8Only one orb applies per player.", " ", "&6Orb Buff: Plasmaflux", "&7Grants &b+125% &7base mana regen.", "&7Heals &c3% &7of max &c❤ &7per second.", "&7Increases all heals by &a+7.5%&7.", "&7Grants &c+35❁ Strength&7", " ", "&4☠ &cRequires &5Wolf Slayer 7", "&6&lLEGENDARY");

    public ItemStack OVERFLUX_POWER_ORB = Utils.addLore(Utils.getSkull("eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvODQ4NTlkMGFkZmM5M2JlMTliYjQ0MWU2ZWRmZDQzZjZiZmU2OTEyNzIzMDMzZjk2M2QwMDlhMTFjNDgyNDUxMCJ9fX0"), "&5Overflux Power Orb", "&6Item Ability: Deploy", "&7Place an orb for &a30s &7buffing", "&7up to &b5 &7players within &a18", "&7blocks", "&8Costs 50% of max mana.", "&8Only one orb applies per player.", " ", "&aOrb Buff: Overflux", "&7Grants &b+100% &7base mana regen.", "&7Heals &c2.5% &7of max &c❤&7 per second.", "&7Increases all heals by &a+5%&7.", "&7Grants &c+25❁ Strength&7.", " ", "&4☠ &cRequires &5Wolf Slayer 7", "&5&lEPIC");
    ...
    public ItemStack WALKING_CANE = Utils.addLore(new ItemStack(Material.STICK), "&5Walking Cane", "Takes 1/4 of your speed and rewards you with 1/4 of your max health restored");

    public ItemStack YOUNG_CRYSTAL = Utils.addLore(new ItemStack(Material.QUARTZ), "&9Young Crystal", "While in your hotbar, this item increases your speed cap by 5%");
}
