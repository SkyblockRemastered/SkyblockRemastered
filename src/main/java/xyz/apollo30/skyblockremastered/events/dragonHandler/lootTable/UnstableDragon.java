...
public class UnstableDragon extends DragLootStructure {
    ...
    public void getItem() {
        ...
        if (weight >= 550 && chance < 10) {
            giveFrags(weight - 550, Fragments.UNSTABLE_FRAGMENT);
            ...
            if (chance < 0.3) {
                ...
                giveFrags(weight, Fragments.UNSTABLE_FRAGMENT);
                if (dragChance < 20) {
                ...
                if (chance < placedEyes * 5) {
                    giveFrags(weight - 450, Fragments.UNSTABLE_FRAGMENT);
