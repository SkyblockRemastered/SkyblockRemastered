    ...
    public void getItem() {
        ...
        if (weight >= 550 && chance < 10) {
            ...
            if (chance < 0.3) {
                ...
                giveFrags(weight - 450, Fragments.YOUNG_FRAGMENT);
                if (dragChance < 20) {
                ...
                giveFrags(weight, Fragments.YOUNG_FRAGMENT);
        ...
        } else giveFrags(weight, Fragments.YOUNG_FRAGMENT);
    }
