...
public class Masterclass {
    public static HashMap<String, DragLootStructure> dragonMap;
    public static HashMap<Player, Integer> placedPlayerEyes = new HashMap<>();

    public Masterclass(SkyblockRemastered plugin) {
        dragonMap = new HashMap<String, DragLootStructure>() {
            {
