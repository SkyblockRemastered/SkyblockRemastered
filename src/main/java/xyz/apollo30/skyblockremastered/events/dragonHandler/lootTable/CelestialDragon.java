...
public class CelestialDragon extends DragLootStructure {
    ...
    public void getItem() {
        ...
        if (weight >= 550 && chance < 10) {
            giveFrags(weight - 550, Fragments.CELESTIAL_FRAGMENT);
            ...
            if (chance < 0.3) {
                ...
                giveFrags(weight - 450, Fragments.CELESTIAL_FRAGMENT);
                if (dragChance < 20) {
                ...
                giveFrags(weight, Fragments.CELESTIAL_FRAGMENT);
