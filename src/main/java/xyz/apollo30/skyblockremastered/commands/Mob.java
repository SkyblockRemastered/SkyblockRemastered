    ...
    public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
        ...
        try {
            for (int i = 0; i < amount; i++) {
                ...
                SkyblockRemastered.mobManager.createMob(entity, customName != null ? customName : args.length == 1 ? WordUtils.capitalizeFully(args[0].replaceAll("_", "").toLowerCase()) : args[2]);
            }
